...
vector<string> get_variables(bool for_use=false){
  vector<string> answer = {"cos_lightJetLepton_tsystem", "cos_lightJetW_tsystem", "cos_leptonW_Wsystem",
                           ...
                           "MVA_bJetTop_dPhi", "MVA_bJetTop_dEta","Lepton_Type", "Jets_N"
...
/*
cd /afs/cern.ch/work/p/pmandrik/tdr_tqgamma/ntupler/CMSSW_9_3_2; cmsenv; cd /afs/cern.ch/work/p/pmandrik/tdr_tqgamma/mensura
*/

void tmva_train(int id=-1, string options=""){
  int try_index = 20;
  ...
  options_map[14] = "NCycles=3000:TestRate=100:LearningRate=0.02:HiddenLayers=N+30,N+30";
  options_map[15] = "NCycles=3000:TestRate=100:LearningRate=0.02:HiddenLayers=N+25,N+25";

  options_map[16] = "NCycles=2000:TestRate=25:LearningRate=0.02:HiddenLayers=N+20,N+20";
  options_map[17] = "NCycles=2000:TestRate=25:LearningRate=0.02:HiddenLayers=N+35,N+35";
  options_map[18] = "NCycles=2500:TestRate=25:LearningRate=0.02:HiddenLayers=N+40,N+40";
  options_map[19] = "NCycles=2000:TestRate=25:LearningRate=0.02:HiddenLayers=N+20,N+20";
  options_map[20] = "NCycles=2200:TestRate=25:LearningRate=0.02:HiddenLayers=N+30,N+30";

  if(id != -1) try_index = -1;
  options_map[1000 + try_index] = options;
...
//dataloader->PrepareTrainingAndTestTree("Lepton_Type==1", "NormMode=EqualNumEvents:nTrain_Signal=20000:nTrain_Background=20000:nTest_Signal=10000" );
  dataloader->PrepareTrainingAndTestTree("", "NormMode=EqualNumEvents:nTrain_Signal=40000:nTest_Signal=20000:nTest_Background=20000" );
